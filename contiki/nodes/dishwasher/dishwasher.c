...
PROCESS(smart_dishwasher, "Smart dishwasher");
AUTOSTART_PROCESSES(&smart_dishwasher);
...
PROCESS_THREAD(smart_dishwasher, ev, data)
{
    ...
    coap_activate_resource(&res_dishwasher, "dishwasher");
